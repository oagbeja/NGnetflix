...
import { IMovies } from './event.model';
...
export class EventService {
    ...
    /*getMovies(): Observable<IMovies[]> {
        return this.http.get<IMovies[]>('http://localhost')
        .pipe(catchError(this.handleError<IMovies[]>('getEvents',[])))
        //MOVIES;
    }*/
    url='/assets/mydata.json'
    //url='api/Movies'
    //getMovies(){
      //return MOVIES this.http.get<Hero[]>(this.heroesUrl)
...
const MOVIES_old = [
    {
        id: 1,
        title: 'Close'  ,
        image:'/assets/images/image_movie.jpg' ,
        year_prod:'2018' ,
        rated: 'PG',
        released: '2019',
        runtime: '2:00:25' ,
